...
class Data(object):
  ...
  def initialize(self):
    ...
    meeting_time4 = MeetingTime(id="MT5", time="TTH 14:00 - 16:00")
    ...
    # create departments
    department1 = Department(name="3 INFO", courses=[course1, course3])
    department2 = Department(name="4 INFO", courses=[course2, course4, course5])
    department3 = Department(name="5 INFO", courses=[course6, course7])
